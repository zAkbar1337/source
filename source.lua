...
local Utility = {}
local Objects = {}
function Akbar:DraggingEnabled(frame, parent)
...
function Akbar.CreateLib(kavName, themeList)
    ...
    Akbar:DraggingEnabled(MainHeader, Main)
    ...
    function Akbar:ChangeColor(prope,color)
